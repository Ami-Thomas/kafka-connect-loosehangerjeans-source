...
public class AbandonedShoppingCartGenerator extends Generator<AbandonedShoppingCart> {
    ...
    public AbandonedShoppingCartGenerator(AbstractConfig config) {
        ...
        this.maxEmails = config.getInt(DatagenSourceConfig.CONFIG_ABANDONEDSHOPPINGCARTS_CUSTOMER_EMAILS_MIN);
    }
